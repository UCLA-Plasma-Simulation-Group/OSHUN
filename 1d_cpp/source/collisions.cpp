...
//-------------------------------------------------------------------
    void self_f00_explicit_collisions::loop(SHarmonic1D& f0){    
...
///
    void  self_flm_implicit_step::reset_coeff(const valarray<double>& fin, const double Delta_t) {
//-------------------------------------------------------------------
...
//     - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
       ...
       _ZLOGei = formulas.Zeta*formulas.LOGei(I0_density,I2_temperature,formulas.Zeta);
//     - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
...
//  Constructor
//-------------------------------------------------------------------
       : self_f00_collisions(DFin, deltat),
...
//-------------------------------------------------------------------
    self_f00_collisions.loop(f00);
}
//-------------------------------------------------------------------
//-------------------------------------------------------------------
    void self_collisions::advanceflm(DistFunc1D& DFin){
//-------------------------------------------------------------------   
      self_flm_collisions.advanceflm(DFin);
}

//-------------------------------------------------------------------
    void self_collisions::advancef1(DistFunc1D& DFin){
//-------------------------------------------------------------------
      self_flm_collisions.advancef1(DFin);
}
////*******************************************************************
//-------------------------------------------------------------------
...
//-------------------------------------------------------------------
    void collisions::advancef0(State1D& Yin)
//-------------------------------------------------------------------
    {
        size_t sdummy(0);
        ...
        // for(size_t s(0); s < Yin.Species(); ++s)
        {        
            self_coll[s].advancef00(Yin.DF(s)(0,0));
...
//-------------------------------------------------------------------
    void collisions::advancef1(State1D& Yin)
//-------------------------------------------------------------------
    {
        size_t sdummy(0);
        ...
        // for(size_t s(0); s < Yin.Species(); ++s)          
        {        
            self_coll[s].advancef1(Yin.DF(s) );
...
//-------------------------------------------------------------------
    void collisions::advanceflm(State1D& Yin)
//-------------------------------------------------------------------
    {
        size_t sdummy(0);
        ...
        // for(size_t s(0); s < Yin.Species(); ++s)
        {        
            self_coll[s].advanceflm(Yin.DF(s) );

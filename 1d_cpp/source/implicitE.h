...
//--------------------------------------------------------------
        public:
            virtual void advance(Algorithms::RK2<State1D>* rk, State1D& Y, collisions& coll, VlasovFunctor1D_implicitE_p2* rkF)=0;//, double time, double dt) = 0; // "covariant" return
...
//          Main function
            void advance(Algorithms::RK2<State1D>* rk, State1D& Y, collisions& coll, VlasovFunctor1D_implicitE_p2* rkF);//, double time, double dt);    

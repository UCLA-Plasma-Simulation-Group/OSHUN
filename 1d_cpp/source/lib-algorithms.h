...
//  abstract functor interface 
        public: 
            ...
            virtual void operator()(const T& Y1in, const T& Y2in, T& Yslope)=0;  // call using operator
            // virtual void implicit_rest(const T& Yin, T& Yslope)=0;  // call using operator
            // virtual void implicit_E(const T& Yin, T& Yslope, size_t dir)=0;  // call using operator
    };
...
//      Main function
        ...
        // T& rest(T& Y, double h, AbstFunctor<T>* F);  
        // T& implicit_E(T& Y, double h, AbstFunctor<T>* F, size_t dir);      
...
//      Main function
        T& operator()(T& Y, double h, AbstFunctor<T>* F);    
        T& operator()(T& Y, T& Y2in, double h, AbstFunctor<T>* F);    
        T& operator()(T& Y, double h, AbstFunctor<T>* F, size_t dir);    
        // T& rest(T& Y, double h, AbstFunctor<T>* F);  
        // T& implicit_E(T& Y, double h, AbstFunctor<T>* F, size_t dir);    
...
//      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
    ...
    template<class T> T& RK4<T>::operator()
        (T& Y, T& Y2in, double h, AbstFunctor<T>* F) {    
//      Take a step using RK4
...
//      Step 1
        (*F)(Y1,Y2in,Yh);                    // slope in the beginning
        Yh *= (0.5*h);   Y1 += Yh;      // Y1 = Y1 + (h/2)*Yh
        Yh *= (1.0/3.0); Y  += Yh;      // Y  = Y  + (h/6)*Yh
//      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

//      Step 2
        (*F)(Y1,Y2in,Yh);     Y1  = Y0;      // slope in the middle
        Yh *= (0.5*h);   Y1 += Yh;      // Y1 = Y0 + (h/2)*Yh
        Yh *= (2.0/3.0); Y  += Yh;      // Y  = Y  + (h/3)*Yh
//      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

//      Step 3
        (*F)(Y1,Y2in,Yh);                    // slope in the middle again
        Yh *= h;          Y0 += Yh;     // Y0 = Y0 + h*Yh
        Yh *= (1.0/3.0);  Y  += Yh;     // Y  = Y  + (h/3)*Yh
//      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 
//      Step 4
        (*F)(Y0,Y2in,Yh);                    // slope at the end
        Yh *= (h/6.0);    Y += Yh;      // Y  = Y  + (h/6)*Yh
//      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 

...
void Setup_Y::applyexternalfields(Grid_Info &grid, State1D& Y, double time)
{
    ...
    {
        Y.EMF().Ex()(ix) += Ex_profile[ix]*ex_time_coeff;
        Y.EMF().Ey()(ix) += Ey_profile[ix]*ey_time_coeff;
        Y.EMF().Ez()(ix) += Ez_profile[ix]*ez_time_coeff;
        Y.EMF().Bx()(ix) += Bx_profile[ix]*bx_time_coeff;
        Y.EMF().By()(ix) += By_profile[ix]*by_time_coeff;
        Y.EMF().Bz()(ix) += Bz_profile[ix]*bz_time_coeff;

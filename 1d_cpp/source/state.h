...
//-------------------------------------------------------------------
    private:
        valarray<double>  *hn, *hv, *ht, *kp, *_jx, *_jy, *_jz, *_ne;
...
//      Access to the underlying matrix
        // valarray<complex<double> >& array() const {return (*fi);}
        size_t numx() const {return (*hv).size();}
        ...
        double & velocity(size_t i){ return (*hv)[i];}             //1D-style 
        double   velocity(size_t i) const {return (*hv)[i];} 
        
        double & temperature(size_t i){ return (*ht)[i];}             //1D-style 
        double   temperature(size_t i) const {return (*ht)[i];} 
        
        double & kpressure(size_t i){ return (*kp)[i];}             //1D-style 
        double   kpressure(size_t i) const {return (*kp)[i];} 

        double & jx(size_t i){ return (*_jx)[i];}             //1D-style 
        double   jx(size_t i) const {return (*_jx)[i];} 

        double & jy(size_t i){ return (*_jy)[i];}             //1D-style 
        double   jy(size_t i) const {return (*_jy)[i];} 

        double & jz(size_t i){ return (*_jz)[i];}             //1D-style 
        double   jz(size_t i) const {return (*_jz)[i];} 

        double & ne(size_t i){ return (*_ne)[i];}             //1D-style 
        double   ne(size_t i) const {return (*_ne)[i];} 

        valarray<double >& densityarray()       const {return (*hn);}
        valarray<double >& velocityarray()      const {return (*hv);}
        valarray<double >& temperaturearray()   const {return (*ht);}

        valarray<double >& kineticspeciespressurearray() const {return (*kp);}

        valarray<double >& jxarray()       const {return (*_jx);}
        valarray<double >& jyarray()       const {return (*_jy);}
        valarray<double >& jzarray()       const {return (*_jz);}

        valarray<double >& electrondensityarray()       const {return (*_ne);}
